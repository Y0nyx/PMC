...
def build_and_train_model():
    wandb.init(project="local_CAE_training_single_v0")
    #Building model 
    model_factory = mod.AeModels()
    ...
    train(model, input_train_norm, input_train_aug_norm, input_test_norm, input_test_aug_norm, 20, 6, callbacks)
